...
export default function EditPopupPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    const fetchPopup = async () => {
      ...
      setPopupId(resolvedParams.id);
      
      try {
        const res = await fetch(`/api/admin/popups/${resolvedParams.id}`);
        ...
        if (data.popup) {
          ...
          setFormData({
            ...
            showTodayClose: popup.showTodayClose,
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">팝업 수정</h2>
